...
export const PHOTO_ID_ATTESTATION: Attestation = {
  ...
  dataSet: [
    { identifier: 'portrait', attribute: 'portrait'},
    { identifier: 'portrait_capture_date', attribute: 'portrait_capture_date'},
    { identifier: 'person_id', attribute: 'person_id'},
    { identifier: 'family_name', attribute: 'family_name'},
    { identifier: 'given_name', attribute: 'given_name'},
    { identifier: 'birth_date', attribute: 'birth_date'},
    { identifier: 'age_over_18', attribute: 'age_over_18'},
    { identifier: 'age_over_NN', attribute: 'age_over_NN'},
    { identifier: 'age_in_years', attribute: 'age_in_years'},
    { identifier: 'age_birth_year', attribute: 'age_birth_year'},
    { identifier: 'family_name_birth', attribute: 'family_name_birth'},
    { identifier: 'given_name_birth', attribute: 'given_name_birth'},
    { identifier: 'birth_place', attribute: 'birth_place'},
    { identifier: 'birth_country', attribute: 'birth_country'},
    { identifier: 'birth_state', attribute: 'birth_state'},
    { identifier: 'birth_city', attribute: 'birth_city'},
    { identifier: 'resident_address', attribute: 'resident_address'},
    { identifier: 'resident_country', attribute: 'resident_country'},
    { identifier: 'resident_state', attribute: 'resident_state'},
    { identifier: 'resident_city', attribute: 'resident_city'},
    { identifier: 'resident_postal_code', attribute: 'resident_postal_code'},
    { identifier: 'resident_street', attribute: 'resident_street'},
    { identifier: 'resident_house_number', attribute: 'resident_house_number'},
    { identifier: 'gender', attribute: 'gender'},
    { identifier: 'nationality', attribute: 'nationality'},
    { identifier: 'issuance_date', attribute: 'issuance_date'},
    { identifier: 'expiry_date', attribute: 'expiry_date'},
    { identifier: 'issuing_authority', attribute: 'issuing_authority'},
    { identifier: 'document_number', attribute: 'document_number'},
    { identifier: 'administrative_number', attribute: 'administrative_number'},
    { identifier: 'issuing_country', attribute: 'issuing_country'},
    { identifier: 'issuing_jurisdiction', attribute: 'issuing_jurisdiction'},
    { identifier: 'portrait', attribute: 'portrait'},
    { identifier: 'portrait_capture_date', attribute: 'portrait_capture_date'},
    { identifier: 'person_id', attribute: 'person_id'},
    { identifier: 'family_name', attribute: 'family_name'},
